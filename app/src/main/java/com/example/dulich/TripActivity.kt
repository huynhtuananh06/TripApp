...
class TripActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tripList = when (place) {

            "Cầu Rồng" -> listOf(
                TripItem.Header("Khách sạn gần Cầu Rồng"),
            ...
            "Bà Nà Hills" -> listOf(
                TripItem.Header("Khách sạn gần Bà Nà Hills"),
            ...
            "Sơn Trà" -> listOf(
                TripItem.Header("Khách sạn gần Sơn Trà"),
            ...
            "Hồ Hoàn Kiếm" -> listOf(
                TripItem.Header("Khách sạn gần Hồ Hoàn Kiếm"),
            ...
            "Văn Miếu" -> listOf(
                TripItem.Header("Khách sạn gần Văn Miếu"),
            ...
            "Phố Cổ" -> listOf(
                TripItem.Header("Khách sạn gần Phố Cổ"),
                ...
                TripItem.Header("Tất cả khách sạn"),
                TripItem.TourItem("Mercure Danang French Village Bana Hills", R.drawable.bana1, 1200000, "4.8"),
                TripItem.TourItem("Vanda Hotel", R.drawable.rong1, 1100000, "4.7"),
                TripItem.TourItem("InterContinental Danang Sun Peninsula Resort", R.drawable.sontra1, 8500000, "4.9")
            )
